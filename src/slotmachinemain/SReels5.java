 ...
 */
public class SReels5 implements Runnable{
...
ImageIcon icon9 = new ImageIcon("RightSep.jpg");
    ...
    public void run() {
        for(int i = 0; i<= 25; i++)
        {
            {if(colorState == true)
        {
            SlotGui.R2Card5.setIcon(icon1);
        }
        if(colorState == false)
        {
            SlotGui.R2Card5.setIcon(icon2);
        }
            while(SlotGui.R2Card5.getLocationOnScreen().y <= bottom)
            {
                SlotGui.R2Card5.setLocation(xpos,SlotGui.R2Card5.getLocationOnScreen().y - (1/100));
            ...
            SlotGui.R2Card5.setLocation(xpos, top);
            if(colorState == true)
            {
                colorState = false;
            }
     ...
     if(SlotGui.Sp2 == 0)
     {
         ...
         while(SlotGui.R2Card5.getLocationOnScreen().y <= stackmt)
            {
                SlotGui.R2Card5.setLocation(xpos,SlotGui.R2Card5.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     else if(SlotGui.Sp2 == 1)
     {
          while(SlotGui.R2Card5.getLocationOnScreen().y <= bottom)
            ...
            SlotGui.R2Card5.setLocation(xpos, top);
         SlotGui.R2Card5.setIcon(icon1);
         while(SlotGui.R2Card5.getLocationOnScreen().y <= (stackt))
            {
                SlotGui.R2Card5.setLocation(xpos,SlotGui.R2Card5.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     {
         SlotGui.R2Card5.setIcon(icon1);
         while(SlotGui.R2Card5.getLocationOnScreen().y <= (stackb))
            {
                SlotGui.R2Card5.setLocation(xpos,SlotGui.R2Card5.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     else if(SlotGui.Sp2 == 3)
     {
         ...
         while(SlotGui.R2Card5.getLocationOnScreen().y <= stackmb)
            {
                SlotGui.R2Card5.setLocation(xpos,SlotGui.R2Card5.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     else if(SlotGui.Sp2 == 4)
     {
         ...
         while(SlotGui.R2Card5.getLocationOnScreen().y <= stackm)
            {
                SlotGui.R2Card5.setLocation(xpos,SlotGui.R2Card5.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
