 ...
 */
public class TReels2 implements Runnable{
...
ImageIcon icon2 = new ImageIcon("BellCardL1.jpg");
...
ImageIcon icon9 = new ImageIcon("RightSep.jpg");
    ...
    public void run() {
        for(int i = 0; i<= 30; i++)
        {
            {if(colorState == true)
        {
           SlotGui.R3Card2.setIcon(icon1);
        }
        if(colorState == false)
        {
           SlotGui.R3Card2.setIcon(icon2);
        }
            while(SlotGui.R3Card2.getLocationOnScreen().y <= bottom)
            {
                SlotGui.R3Card2.setLocation(xpos,SlotGui.R3Card2.getLocationOnScreen().y - (1/100));
            ...
            SlotGui.R3Card2.setLocation(xpos, top);
            if(colorState == true)
            {
                colorState = false;
            }
     ...
     {
        SlotGui.R3Card2.setIcon(icon1);
         while(SlotGui.R3Card2.getLocationOnScreen().y <= stackmb)
            {
                SlotGui.R3Card2.setLocation(xpos,SlotGui.R3Card2.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     {
         SlotGui.R3Card2.setIcon(icon1);
         while(SlotGui.R3Card2.getLocationOnScreen().y <= (stackm))
            {
                SlotGui.R3Card2.setLocation(xpos,SlotGui.R3Card2.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
    ...
    //3 wins
     ...
     {
         SlotGui.R3Card2.setIcon(icon1);
         while(SlotGui.R3Card2.getLocationOnScreen().y <= (stackmt))
            {
                SlotGui.R3Card2.setLocation(xpos,SlotGui.R3Card2.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
    ...
    //4 wins
    else if(SlotGui.Sp3 == 3)
     {
         ...
         SlotGui.R3Card2.setIcon(icon1);
         while(SlotGui.R3Card2.getLocationOnScreen().y <= (stackt))
            {
                SlotGui.R3Card2.setLocation(xpos,SlotGui.R3Card2.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
