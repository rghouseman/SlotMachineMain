...
public class Reels5 implements Runnable{
...
ImageIcon icon9 = new ImageIcon("RightSep.jpg");
    ...
    public void run() {
       for(int i = 0; i<= 20; i++)
        {if(colorState == true)
        {
            SlotGui.Card5.setIcon(icon1);
        }
        if(colorState == false)
        {
            SlotGui.Card5.setIcon(icon2);
        }
            while(SlotGui.Card5.getLocationOnScreen().y <= bottom)
            {
                SlotGui.Card5.setLocation(xpos,SlotGui.Card5.getLocationOnScreen().y - (1/100));
            ...
            SlotGui.Card5.setLocation(xpos, top);
            if(colorState == true)
            {
                colorState = false;
            }
     ...
     if(SlotGui.Sp1 == 0)
     {
         ...
         while(SlotGui.Card5.getLocationOnScreen().y <= stackmt)
            {
                SlotGui.Card5.setLocation(xpos,SlotGui.Card5.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     else if(SlotGui.Sp1 == 1)
     {
          while(SlotGui.Card5.getLocationOnScreen().y <= bottom)
            ...
            SlotGui.Card5.setLocation(xpos, top);
         SlotGui.Card5.setIcon(icon1);
         while(SlotGui.Card5.getLocationOnScreen().y <= (stackt))
            {
                SlotGui.Card5.setLocation(xpos,SlotGui.Card5.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     {
         SlotGui.Card5.setIcon(icon1);
         while(SlotGui.Card5.getLocationOnScreen().y <= (stackb))
            {
                SlotGui.Card5.setLocation(xpos,SlotGui.Card5.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     else if(SlotGui.Sp1 == 3)
     {
         ...
         while(SlotGui.Card5.getLocationOnScreen().y <= stackmb)
            {
                SlotGui.Card5.setLocation(xpos,SlotGui.Card5.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     else if(SlotGui.Sp1 == 4)
     {
         ...
         while(SlotGui.Card5.getLocationOnScreen().y <= stackm)
            {
                SlotGui.Card5.setLocation(xpos,SlotGui.Card5.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
