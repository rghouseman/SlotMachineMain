 ...
 */
public class SReels4 implements Runnable{
...
ImageIcon icon2 = new ImageIcon("BarCardL1.jpg");
...
ImageIcon icon9 = new ImageIcon("RightSep.jpg");
    ...
    public void run() {
        for(int i = 0; i<= 25; i++)
        {
            {if(colorState == true)
        {
            SlotGui.R2Card4.setIcon(icon1);
        }
        if(colorState == false)
        {
           SlotGui.R2Card4.setIcon(icon2);
        }
            while(SlotGui.R2Card4.getLocationOnScreen().y <= bottom)
            {
                SlotGui.R2Card4.setLocation(xpos,SlotGui.R2Card4.getLocationOnScreen().y - (1/100));
            ...
            SlotGui.R2Card4.setLocation(xpos, top);
            if(colorState == true)
            {
                colorState = false;
            }
     ...
     if(SlotGui.Sp2 == 0)
     {
         ...
         SlotGui.R2Card4.setIcon(icon1);
         while(SlotGui.R2Card4.getLocationOnScreen().y <= (stackt))
            {
                SlotGui.R2Card4.setLocation(xpos,SlotGui.R2Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     {
         SlotGui.R2Card4.setIcon(icon1);
         while(SlotGui.R2Card4.getLocationOnScreen().y <= (stackb))
            {
                SlotGui.R2Card4.setLocation(xpos,SlotGui.R2Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     {
         SlotGui.R2Card4.setIcon(icon1);
         while(SlotGui.R2Card4.getLocationOnScreen().y <= (stackmb))
            {
                SlotGui.R2Card4.setLocation(xpos,SlotGui.R2Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     else if(SlotGui.Sp2 == 3)
     {
         ...
         SlotGui.R2Card4.setIcon(icon1);
         while(SlotGui.R2Card4.getLocationOnScreen().y <= (stackm))
            {
                SlotGui.R2Card4.setLocation(xpos,SlotGui.R2Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     else if(SlotGui.Sp2 == 4)
     {
         ...
         SlotGui.R2Card4.setIcon(icon1);
         while(SlotGui.R2Card4.getLocationOnScreen().y <= (stackmt))
            {
                SlotGui.R2Card4.setLocation(xpos,SlotGui.R2Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
