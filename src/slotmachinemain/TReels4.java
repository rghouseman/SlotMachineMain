 ...
 */
public class TReels4 implements Runnable{
...
int bottom = 340;
int xpos = 510;
ImageIcon icon1 = new ImageIcon("DieCardL1.jpg");
...
ImageIcon icon9 = new ImageIcon("RightSep.jpg");
    ...
    public void run() {
        for(int i = 0; i<= 30; i++)
        {
            {if(colorState == true)
        {
            SlotGui.R3Card4.setIcon(icon1);
        }
        if(colorState == false)
        {
           SlotGui.R3Card4.setIcon(icon2);
        }
            while(SlotGui.R3Card4.getLocationOnScreen().y <= bottom)
            {
                SlotGui.R3Card4.setLocation(xpos,SlotGui.R3Card4.getLocationOnScreen().y - (1/100));
            ...
            SlotGui.R3Card4.setLocation(xpos, top);
            if(colorState == true)
            {
                colorState = false;
            }
     ...
     if(SlotGui.Sp3 == 0)
     {
         ...
         SlotGui.R3Card4.setIcon(icon1);
         while(SlotGui.R3Card4.getLocationOnScreen().y <= (stackt))
            {
                SlotGui.R3Card4.setLocation(xpos,SlotGui.R3Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     {
         SlotGui.R3Card4.setIcon(icon1);
         while(SlotGui.R3Card4.getLocationOnScreen().y <= (stackb))
            {
                SlotGui.R3Card4.setLocation(xpos,SlotGui.R3Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     {
         SlotGui.R3Card4.setIcon(icon1);
         while(SlotGui.R3Card4.getLocationOnScreen().y <= (stackmb))
            {
                SlotGui.R3Card4.setLocation(xpos,SlotGui.R3Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     else if(SlotGui.Sp3 == 3)
     {
         ...
         SlotGui.R3Card4.setIcon(icon1);
         while(SlotGui.R3Card4.getLocationOnScreen().y <= (stackm))
            {
                SlotGui.R3Card4.setLocation(xpos,SlotGui.R3Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     else if(SlotGui.Sp3 == 4)
     {
         ...
         SlotGui.R3Card4.setIcon(icon1);
         while(SlotGui.R3Card4.getLocationOnScreen().y <= (stackmt))
            {
                SlotGui.R3Card4.setLocation(xpos,SlotGui.R3Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
