 ...
 */
public class TReels implements Runnable{
...
int bottom = 340;
int xpos = 510;
ImageIcon icon1 = new ImageIcon("CherryCardL1.jpg");
ImageIcon icon2 = new ImageIcon("HShoeCardL1.jpg");
...
ImageIcon icon9 = new ImageIcon("RightSep.jpg");
    ...
    public void run() {
        for(int i = 0; i<= 30; i++)
        {
            {if(colorState == true)
        {
            SlotGui.R3Card1.setIcon(icon1);
        }
        if(colorState == false)
        {
            SlotGui.R3Card1.setIcon(icon2);
        }
            while(SlotGui.R3Card1.getLocationOnScreen().y <= bottom)
            {
                SlotGui.R3Card1.setLocation(xpos,SlotGui.R3Card1.getLocationOnScreen().y - (1/100));
            ...
            SlotGui.R3Card1.setLocation(xpos, top);
            if(colorState == true)
            {
                colorState = false;
            }
     ...
     if(SlotGui.Sp3 == 0)
     {
         ...
         while(SlotGui.R3Card1.getLocationOnScreen().y <= (stackm))
            {
                SlotGui.R3Card1.setLocation(xpos,SlotGui.R3Card1.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     {
         SlotGui.R3Card1.setIcon(icon1);
         while(SlotGui.R3Card1.getLocationOnScreen().y <= (stackmt))
            {
                SlotGui.R3Card1.setLocation(xpos,SlotGui.R3Card1.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     {
         SlotGui.R3Card1.setIcon(icon1);
         while(SlotGui.R3Card1.getLocationOnScreen().y <= (stackt))
            {
                SlotGui.R3Card1.setLocation(xpos,SlotGui.R3Card1.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
    ...
    //4 wins
     ...
     {
         SlotGui.R3Card1.setIcon(icon1);
         while(SlotGui.R3Card1.getLocationOnScreen().y <= (stackb))
            {
                SlotGui.R3Card1.setLocation(xpos,SlotGui.R3Card1.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     {
         SlotGui.R3Card1.setIcon(icon1);
         while(SlotGui.R3Card1.getLocationOnScreen().y <= (stackmb))
            {
                SlotGui.R3Card1.setLocation(xpos,SlotGui.R3Card1.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
    ...
    else if(SlotGui.Sp3 == 9)
     {
        ...
        String Pay = Double.toString(SlotGui.newPlayer.getPayout());
        SlotGui.Payout.setText("$" + Pay);
       
        String Won = Double.toString(SlotGui.newPlayer.getTotalW());
        SlotGui.TotalW.setText("$" + Won);
    }
