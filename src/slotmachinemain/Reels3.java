 ...
 */
public class Reels3 implements Runnable{
...
int bottom = 340;
int xpos = 210;
ImageIcon icon1 = new ImageIcon("GrapeCardL1.jpg");
ImageIcon icon2 = new ImageIcon("DiamondCardL1.jpg");
...
ImageIcon icon9 = new ImageIcon("RightSep.jpg");
    ...
    public void run() {
       for(int i = 0; i<= 20; i++)
        {
            {if(colorState == true)
        {
           SlotGui.Card3.setIcon(icon1);
        }
        if(colorState == false)
        {
           SlotGui.Card3.setIcon(icon2); 
        }
            while(SlotGui.Card3.getLocationOnScreen().y <= bottom)
            {
                SlotGui.Card3.setLocation(xpos,SlotGui.Card3.getLocationOnScreen().y - (1/100));
            ...
            SlotGui.Card3.setLocation(xpos, top);
            if(colorState == true)
            {
                colorState = false;
            }
     ...
     {
         SlotGui.Card3.setIcon(icon1);
         while(SlotGui.Card3.getLocationOnScreen().y <= (stackb))
            {
                SlotGui.Card3.setLocation(xpos,SlotGui.Card3.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
       ...
       else if(SlotGui.Sp1 == 1)
     {
         ...
         while(SlotGui.Card3.getLocationOnScreen().y <= (stackmb))
            {
                SlotGui.Card3.setLocation(xpos,SlotGui.Card3.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
       ...
       else if(SlotGui.Sp1 == 2)
     {
         ...
         while(SlotGui.Card3.getLocationOnScreen().y <= (stackm))
            {
                SlotGui.Card3.setLocation(xpos,SlotGui.Card3.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
       ...
       else if(SlotGui.Sp1 == 3)
     {
         ...
         while(SlotGui.Card3.getLocationOnScreen().y <= (stackmt))
            {
                SlotGui.Card3.setLocation(xpos,SlotGui.Card3.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
       ...
       else if(SlotGui.Sp1 == 4)
     {
         ...
         while(SlotGui.Card3.getLocationOnScreen().y <= (stackt))
            {
                SlotGui.Card3.setLocation(xpos,SlotGui.Card3.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
