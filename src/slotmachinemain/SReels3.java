 ...
 */
public class SReels3 implements Runnable{
...
int bottom = 340;
int xpos = 370;
ImageIcon icon1 = new ImageIcon("SevenCardL1.jpg");
ImageIcon icon2 = new ImageIcon("CoinsCardL1.jpg");
...
ImageIcon icon9 = new ImageIcon("RightSep.jpg");
    ...
    public void run() {
     ...
     {
         SlotGui.R2Card3.setIcon(icon1);
         while(SlotGui.R2Card3.getLocationOnScreen().y <= (stackb))
            {
                SlotGui.R2Card3.setLocation(xpos,SlotGui.R2Card3.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
       ...
       else if(SlotGui.Sp2 == 1)
     {
         ...
         while(SlotGui.R2Card3.getLocationOnScreen().y <= (stackmb))
            {
                SlotGui.R2Card3.setLocation(xpos,SlotGui.R2Card3.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
       ...
       else if(SlotGui.Sp2 == 2)
     {
         ...
         while(SlotGui.R2Card3.getLocationOnScreen().y <= (stackm))
            {
                SlotGui.R2Card3.setLocation(xpos,SlotGui.R2Card3.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
       ...
       else if(SlotGui.Sp2 == 3)
     {
         ...
         while(SlotGui.R2Card3.getLocationOnScreen().y <= (stackmt))
            {
                SlotGui.R2Card3.setLocation(xpos,SlotGui.R2Card3.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
