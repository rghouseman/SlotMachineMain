 ...
 */
public class Reels4 implements Runnable{
...
int bottom = 340;
int xpos = 210;
ImageIcon icon1 = new ImageIcon("BarCardL1.jpg");
...
ImageIcon icon9 = new ImageIcon("RightSep.jpg");
    ...
    public void run() {
       for(int i = 0; i<= 20; i++)
        {
            {if(colorState == true)
        {
            SlotGui.Card4.setIcon(icon1);
        }
        if(colorState == false)
        {
            SlotGui.Card4.setIcon(icon2);
        }
            while(SlotGui.Card4.getLocationOnScreen().y <= bottom)
            {
                SlotGui.Card4.setLocation(xpos,SlotGui.Card4.getLocationOnScreen().y - (1/100));
            ...
            SlotGui.Card4.setLocation(xpos, top);
            if(colorState == true)
            {
                colorState = false;
            }
     ...
     if(SlotGui.Sp1 == 0)
     {
         ...
         SlotGui.Card4.setIcon(icon1);
         while(SlotGui.Card4.getLocationOnScreen().y <= (stackt))
            {
                SlotGui.Card4.setLocation(xpos,SlotGui.Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     {
         SlotGui.Card4.setIcon(icon1);
         while(SlotGui.Card4.getLocationOnScreen().y <= (stackb))
            {
                SlotGui.Card4.setLocation(xpos,SlotGui.Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     {
         SlotGui.Card4.setIcon(icon1);
         while(SlotGui.Card4.getLocationOnScreen().y <= (stackmb))
            {
                SlotGui.Card4.setLocation(xpos,SlotGui.Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     else if(SlotGui.Sp1 == 3)
     {
         ...
         SlotGui.Card4.setIcon(icon1);
         while(SlotGui.Card4.getLocationOnScreen().y <= (stackm))
            {
                SlotGui.Card4.setLocation(xpos,SlotGui.Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
     ...
     else if(SlotGui.Sp1 == 4)
     {
         ...
         SlotGui.Card4.setIcon(icon1);
         while(SlotGui.Card4.getLocationOnScreen().y <= (stackmt))
            {
                SlotGui.Card4.setLocation(xpos,SlotGui.Card4.getLocationOnScreen().y - (1/100));
                SlotGui.jLabel1.setIcon(icon3);
                SlotGui.jLabel2.setIcon(icon4);
